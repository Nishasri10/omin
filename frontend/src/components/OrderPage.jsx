        ...
        {orders.length === 0 ? (
          ...
          <div className="space-y-6">
            {orders.map((order, index) => (
              <div key={order._id || index} className="overflow-hidden rounded-2xl bg-white shadow-lg">
                <div className="flex flex-col gap-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">${order.pricing?.total?.toFixed(2)}</p>
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    {order.transactionId && (
                      <span className="text-xs text-gray-400 font-mono">Txn: {order.transactionId}</span>
                    )}
                  </div>
                </div>
